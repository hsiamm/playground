<?php
/**
 * @version		$Id: default.php 1279 2011-10-27 16:52:58Z joomlaworks $
 * @package		K2
											...
											<td>
												<div id="k2VideoTabs" class="simpleTabs">
													...
													<div id="k2VideoTab4" class="simpleTabsContent">
														<div class="panel" id="embedVideo"> <?php echo JText::_('K2_PASTE_HTML_EMBED_CODE_BELOW'); ?>
															<br />
											...
											<td>
												<div id="k2VideoTabs" class="simpleTabs">
													...
													<div class="simpleTabsContent" id="k2VideoTab4">
														<div class="panel" id="embedVideo"><?php echo JText::_('K2_PASTE_VIDEO_HTML_EMBED_CODE_BELOW'); ?>:
															<br />
															<textarea name="embedVideo" rows="5" cols="50" class="textarea"><?php echo $this->lists['embedVideo']; ?></textarea>
														</div>
													</div>
