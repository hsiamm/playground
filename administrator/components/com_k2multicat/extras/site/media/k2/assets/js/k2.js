/**
 * @version 	$Id: k2.js 1256 2011-10-21 15:55:55Z lefteris.kavadas $
 * @package 	K2
...
$K2(document).ready(function(){
	...
	$K2('#jToggler').click(function(){
		if($K2(this).attr('checked')){
			$K2('input[name=boxchecked]').val('1')
	...
	var view = $K2('input[name=view]').val();
	switch(view){
		...
		case 'item':
			...
			$K2('#catid').change(function(){
				...
				//end
				 ...
				 url = url +'&id='+$K2('input[name=id]').val();
