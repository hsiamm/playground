...
<form id="new-application" class="menu-has-level3" action="index.php" method="post" name="adminForm" accept-charset="utf-8">
		...
		<div class="element element-name">
			...
			<div id="name-edit">
				...
				<div class="slug">
					...
					<a class="trigger" href="#" title="<?php echo JText::_('Edit Application Slug');?>"><?php echo $this->application->alias; ?></a>
					<div class="panel">
...
<script type="text/javascript">
	jQuery(function($) {
		$('#new-application').ApplicationEdit({url: 'index.php?option=com_zoo&controller=new', application_id: '<?php echo $this->application->id; ?>', application_group: '<?php echo $this->application->getGroup();?>'});
