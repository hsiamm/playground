<?php
/**
 * NoNumber! Elements Helper File: Assignments: FlexiContent
 *
...
*/
class NoNumberElementsAssignmentsFlexiContent
{
	var $_version = '2.9.1';
	...
	function passCategories_FC( &$main, &$params, $selection = array(), $assignment = 'all', $article = 0 )
	{
		...
		if ( $pass && $params->inc_children == 2 ) {
			...
			foreach ( $cats as $cat ) {
				$cats = array_merge( $cats, NoNumberElementsAssignmentsFlexiContent::getCatParentIds( $main, $cat ) );
			}
		}
	...
	function passTags_FC( &$main, &$params, $selection = array(), $assignment = 'all' )
	{
		...
		return $main->passSimple( $tags, $selection, $assignment );
	}
