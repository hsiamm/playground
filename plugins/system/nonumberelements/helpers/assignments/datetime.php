<?php
/**
 * NoNumber! Elements Helper File: Assignments: DateTime
 *
...
*/
class NoNumberElementsAssignmentsDateTime
{
	var $_version = '2.9.1';
	...
	{
		$season = NoNumberElementsAssignmentsDateTime::getSeason( $main->_date, $params->hemisphere );
