...
<body id="about">
	...
	<div class="bump">&nbsp;</div>		
		...
		<div class="fivecol_staff">
			...
			<h2 class="nomar blue">Matt Carter</h2>
		...
		<div class="fivecol_staff">
			...
			<h2 class="nomar blue">Staff Person</h2>
			<h3 class="nomar nocap">Title of dude/dudette which is longer than the others</h3>
			<div class="rule_wh_short"></div><!--/\/\/\rule/\/\/\-->
			<h4 class="nomar">WHAT I DO:</h4>
			<h4>Drumstick meatballpork loin beef, venison spare ribs beef ribs corned beef ham shankle short loin. Cow drumstick venison, tenderloin plus th</h4>
			<div class="bump"></div>
		</div><!--/fivecol_staff-->
