...
mejs.Utility={encodeUrl:function(b){return encodeURIComponent(b)},escapeHTML:function(b){return b.toString().split("&").join("&amp;").split("<").join("&lt;").split('"').join("&quot;")},absolutizeUrl:function(b){var a=document.createElement("div");a.innerHTML='<a href="'+this.escapeHTML(b)+'">x</a>';return a.firstChild.href},getScriptPath:function(b){for(var a=0,c,d="",e="",f,g=document.getElementsByTagName("script"),j=g.length,h=b.length;a<j;a++){f=g[a].src;for(c=0;c<h;c++)if(e=b[c],f.indexOf(e)>
-1){d=f.substring(0,f.indexOf(e));break}if(d!=="")break}return d},secondsToTimeCode:function(b,a,c,d){typeof c=="undefined"?c=false:typeof d=="undefined"&&(d=25);var e=Math.floor(b/3600)%24,f=Math.floor(b/60)%60,g=Math.floor(b%60),b=Math.floor((b%1*d).toFixed(3));return(a||e>0?(e<10?"0"+e:e)+":":"")+(f<10?"0"+f:f)+":"+(g<10?"0"+g:g)+(c?":"+(b<10?"0"+b:b):"")},timeCodeToSeconds:function(b,a,c,d){typeof c=="undefined"?c=false:typeof d=="undefined"&&(d=25);var b=b.split(":"),a=parseInt(b[0],10),e=parseInt(b[1],
10),f=parseInt(b[2],10),g=0;c&&(g=parseInt(b[3])/d);return a*3600+e*60+f+g},removeSwf:function(b){var a=document.getElementById(b);if(a&&a.nodeName=="OBJECT")mejs.MediaFeatures.isIE?(a.style.display="none",function(){a.readyState==4?mejs.Utility.removeObjectInIE(b):setTimeout(arguments.callee,10)}()):a.parentNode.removeChild(a)},removeObjectInIE:function(b){if(b=document.getElementById(b)){for(var a in b)typeof b[a]=="function"&&(b[a]=null);b.parentNode.removeChild(b)}}};
mejs.PluginDetector={hasPluginVersion:function(b,a){var c=this.plugins[b];a[1]=a[1]||0;a[2]=a[2]||0;return c[0]>a[0]||c[0]==a[0]&&c[1]>a[1]||c[0]==a[0]&&c[1]==a[1]&&c[2]>=a[2]?true:false},nav:window.navigator,ua:window.navigator.userAgent.toLowerCase(),plugins:[],addPlugin:function(b,a,c,d,e){this.plugins[b]=this.detectPlugin(a,c,d,e)},detectPlugin:function(b,a,c,d){var e=[0,0,0],f;if(typeof this.nav.plugins!="undefined"&&typeof this.nav.plugins[b]=="object"){if((c=this.nav.plugins[b].description)&&
!(typeof this.nav.mimeTypes!="undefined"&&this.nav.mimeTypes[a]&&!this.nav.mimeTypes[a].enabledPlugin)){e=c.replace(b,"").replace(/^\s+/,"").replace(/\sr/gi,".").split(".");for(b=0;b<e.length;b++)e[b]=parseInt(e[b].match(/\d+/),10)}}else if(typeof window.ActiveXObject!="undefined")try{if(f=new ActiveXObject(c))e=d(f)}catch(g){}return e}};
...
mejs.MediaFeatures={init:function(){var b=this,a=document,c=mejs.PluginDetector.nav,d=mejs.PluginDetector.ua.toLowerCase(),e,f=["source","track","audio","video"];b.isiPad=d.match(/ipad/i)!==null;b.isiPhone=d.match(/iphone/i)!==null;b.isiOS=b.isiPhone||b.isiPad;b.isAndroid=d.match(/android/i)!==null;b.isBustedAndroid=d.match(/android 2\.[12]/)!==null;b.isIE=c.appName.toLowerCase().indexOf("microsoft")!=-1;b.isChrome=d.match(/chrome/gi)!==null;b.isFirefox=d.match(/firefox/gi)!==null;b.isWebkit=d.match(/webkit/gi)!==
null;b.isGecko=d.match(/gecko/gi)!==null&&!b.isWebkit;b.isOpera=d.match(/opera/gi)!==null;b.hasTouch="ontouchstart"in window;for(c=0;c<f.length;c++)e=document.createElement(f[c]);b.supportsMediaTag=typeof e.canPlayType!=="undefined"||b.isBustedAndroid;b.hasSemiNativeFullScreen=typeof e.webkitEnterFullscreen!=="undefined";b.hasWebkitNativeFullScreen=typeof e.webkitRequestFullScreen!=="undefined";b.hasMozNativeFullScreen=typeof e.mozRequestFullScreen!=="undefined";b.hasTrueNativeFullScreen=b.hasWebkitNativeFullScreen||
...
mejs.HtmlMediaElement={pluginType:"native",isFullScreen:false,setCurrentTime:function(b){this.currentTime=b},setMuted:function(b){this.muted=b},setVolume:function(b){this.volume=b},stop:function(){this.pause()},setSrc:function(b){for(var a=this.getElementsByTagName("source");a.length>0;)this.removeChild(a[0]);if(typeof b=="string")this.src=b;else for(var c,a=0;a<b.length;a++)if(c=b[a],this.canPlayType(c.type))this.src=c.src},setVideoSize:function(b,a){this.width=b;this.height=a}};
...
null&&this.pluginApi.setFullscreen&&this.setFullscreen(false)},addEventListener:function(b,a){this.events[b]=this.events[b]||[];this.events[b].push(a)},removeEventListener:function(b,a){if(!b)return this.events={},true;var c=this.events[b];if(!c)return true;if(!a)return this.events[b]=[],true;for(i=0;i<c.length;i++)if(c[i]===a)return this.events[b].splice(i,1),true;return false},dispatchEvent:function(b){var a,c,d=this.events[b];if(d){c=Array.prototype.slice.call(arguments,1);for(a=0;a<d.length;a++)d[a].apply(null,
...
c)}},fireEvent:function(b,a,c){var d,e,b=this.pluginMediaElements[b];b.ended=false;b.paused=true;a={type:a,target:b};for(d in c)b[d]=c[d],a[d]=c[d];e=c.bufferedTime||0;a.target.buffered=a.buffered={start:function(){return 0},end:function(){return e},length:1};b.dispatchEvent(a.type,a)}};
...
mejs.HtmlMediaElementShim={create:function(b,a){var c=mejs.MediaElementDefaults,d=typeof b=="string"?document.getElementById(b):b,e=d.tagName.toLowerCase(),f=e==="audio"||e==="video",g=f?d.getAttribute("src"):d.getAttribute("href"),e=d.getAttribute("poster"),j=d.getAttribute("autoplay"),h=d.getAttribute("preload"),l=d.getAttribute("controls"),k;for(k in a)c[k]=a[k];e=typeof e=="undefined"||e===null?"":e;h=typeof h=="undefined"||h===null||h==="false"?"none":h;j=!(typeof j=="undefined"||j===null||j===
"false");l=!(typeof l=="undefined"||l===null||l==="false");k=this.determinePlayback(d,c,mejs.MediaFeatures.supportsMediaTag,f,typeof g=="undefined"||g===null||g==""?null:g);k.url=k.url!==null?mejs.Utility.absolutizeUrl(k.url):"";if(k.method=="native"){if(mejs.MediaFeatures.isBustedAndroid)d.src=k.url,d.addEventListener("click",function(){d.play()},false);return this.updateNative(k,c,j,h)}else return k.method!==""?this.createPlugin(k,c,e,j,h,l):(this.createErrorMessage(k,c,e),this)},determinePlayback:function(b,
...
j.getAttribute("type")),f.push({type:j,url:e}));if(!d&&f.length>0&&f[0].url!==null&&this.getTypeFromFile(f[0].url).indexOf("audio")>-1)h.isVideo=false;if(mejs.MediaFeatures.isBustedAndroid)b.canPlayType=function(a){return a.match(/video\/(mp4|m4v)/gi)!==null?"maybe":""};if(c&&(a.mode==="auto"||a.mode==="native")){if(!d)g=document.createElement(h.isVideo?"video":"audio"),b.parentNode.insertBefore(g,b),b.style.display="none",h.htmlMediaElement=b=g;for(g=0;g<f.length;g++)if(b.canPlayType(f[g].type).replace(/no/,
"")!==""||b.canPlayType(f[g].type.replace(/mp3/,"mpeg")).replace(/no/,"")!==""){h.method="native";h.url=f[g].url;break}if(h.method==="native"){if(h.url!==null)b.src=h.url;return h}}if(a.mode==="auto"||a.mode==="shim")for(g=0;g<f.length;g++){j=f[g].type;for(b=0;b<a.plugins.length;b++){e=a.plugins[b];l=mejs.plugins[e];for(c=0;c<l.length;c++)if(k=l[c],k.version==null||mejs.PluginDetector.hasPluginVersion(e,k.version))for(d=0;d<k.types.length;d++)if(j==k.types[d])return h.method=e,h.url=f[g].url,h}}if(h.method===
""&&f.length>0)h.url=f[0].url;return h},formatType:function(b,a){return b&&!a?this.getTypeFromFile(b):a&&~a.indexOf(";")?a.substr(0,a.indexOf(";")):a},getTypeFromFile:function(b){b=b.substring(b.lastIndexOf(".")+1);return(/(mp4|m4v|ogg|ogv|webm|flv|wmv|mpeg|mov)/gi.test(b)?"video":"audio")+"/"+b},createErrorMessage:function(b,a,c){var d=b.htmlMediaElement,e=document.createElement("div");e.className="me-cannotplay";try{e.style.width=d.width+"px",e.style.height=d.height+"px"}catch(f){}e.innerHTML=c!==
""?'<a href="'+b.url+'"><img src="'+c+'" width="100%" height="100%" /></a>':'<a href="'+b.url+'"><span>Download File</span></a>';d.parentNode.insertBefore(e,d);d.style.display="none";a.error(d)},createPlugin:function(b,a,c,d,e,f){var c=b.htmlMediaElement,g=1,j=1,h="me_"+b.method+"_"+mejs.meIndex++,l=new mejs.PluginMediaElement(h,b.method,b.url),k=document.createElement("div"),m;l.tagName=c.tagName;for(m=0;m<c.attributes.length;m++){var n=c.attributes[m];n.specified==true&&l.setAttribute(n.name,n.value)}for(m=
c.parentNode;m!==null&&m.tagName.toLowerCase()!="body";){if(m.parentNode.tagName.toLowerCase()=="p"){m.parentNode.parentNode.insertBefore(m,m.parentNode);break}m=m.parentNode}b.isVideo?(g=a.videoWidth>0?a.videoWidth:c.getAttribute("width")!==null?c.getAttribute("width"):a.defaultVideoWidth,j=a.videoHeight>0?a.videoHeight:c.getAttribute("height")!==null?c.getAttribute("height"):a.defaultVideoHeight,g=mejs.Utility.encodeUrl(g),j=mejs.Utility.encodeUrl(j)):a.enablePluginDebug&&(g=320,j=240);l.success=
a.success;mejs.MediaPluginBridge.registerPluginElement(h,l,c);k.className="me-plugin";k.id=h+"_container";b.isVideo?c.parentNode.insertBefore(k,c):document.body.insertBefore(k,document.body.childNodes[0]);d=["id="+h,"isvideo="+(b.isVideo?"true":"false"),"autoplay="+(d?"true":"false"),"preload="+e,"width="+g,"startvolume="+a.startVolume,"timerrate="+a.timerRate,"height="+j];b.url!==null&&(b.method=="flash"?d.push("file="+mejs.Utility.encodeUrl(b.url)):d.push("file="+b.url));a.enablePluginDebug&&d.push("debug=true");
a.enablePluginSmoothing&&d.push("smoothing=true");f&&d.push("controls=true");a.pluginVars&&(d=d.concat(a.pluginVars));switch(b.method){case "silverlight":k.innerHTML='<object data="data:application/x-silverlight-2," type="application/x-silverlight-2" id="'+h+'" name="'+h+'" width="'+g+'" height="'+j+'"><param name="initParams" value="'+d.join(",")+'" /><param name="windowless" value="true" /><param name="background" value="black" /><param name="minRuntimeVersion" value="3.0.0.0" /><param name="autoUpgrade" value="true" /><param name="source" value="'+
...
l.vimeoid+'&amp;server=vimeo.com&amp;show_title=0&amp;show_byline=0&amp;show_portrait=0&amp;color=00adef&amp;fullscreen=1&amp;autoplay=0&amp;loop=0" /><embed src="//vimeo.com/moogaloop.swf?api=1&amp;clip_id='+l.vimeoid+'&amp;server=vimeo.com&amp;show_title=0&amp;show_byline=0&amp;show_portrait=0&amp;color=00adef&amp;fullscreen=1&amp;autoplay=0&amp;loop=0" type="application/x-shockwave-flash" allowfullscreen="true" allowscriptaccess="always" width="'+g+'" height="'+j+'"></embed></object>'}c.style.display=
"none";return l},updateNative:function(b,a){var c=b.htmlMediaElement,d;for(d in mejs.HtmlMediaElement)c[d]=mejs.HtmlMediaElement[d];a.success(c,c);return c}};
mejs.YouTubeApi={isIframeStarted:false,isIframeLoaded:false,loadIframeApi:function(){if(!this.isIframeStarted){var b=document.createElement("script");b.src="http://www.youtube.com/player_api";var a=document.getElementsByTagName("script")[0];a.parentNode.insertBefore(b,a);this.isIframeStarted=true}},iframeQueue:[],enqueueIframe:function(b){this.isLoaded?this.createIframe(b):(this.loadIframeApi(),this.iframeQueue.push(b))},createIframe:function(b){var a=b.pluginMediaElement,c=new YT.Player(b.containerId,
{height:b.height,width:b.width,videoId:b.videoId,playerVars:{controls:0},events:{onReady:function(){b.pluginMediaElement.pluginApi=c;mejs.MediaPluginBridge.initPlugin(b.pluginId);setInterval(function(){mejs.YouTubeApi.createEvent(c,a,"timeupdate")},250)},onStateChange:function(b){mejs.YouTubeApi.handleStateChange(b.data,c,a)}}})},createEvent:function(b,a,c){c={type:c,target:a};if(b&&b.getDuration){a.currentTime=c.currentTime=b.getCurrentTime();a.duration=c.duration=b.getDuration();c.paused=a.paused;
c.ended=a.ended;c.muted=b.isMuted();c.volume=b.getVolume()/100;c.bytesTotal=b.getVideoBytesTotal();c.bufferedBytes=b.getVideoBytesLoaded();var d=c.bufferedBytes/c.bytesTotal*c.duration;c.target.buffered=c.buffered={start:function(){return 0},end:function(){return d},length:1}}a.dispatchEvent(c.type,c)},iFrameReady:function(){for(this.isIframeLoaded=this.isLoaded=true;this.iframeQueue.length>0;)this.createIframe(this.iframeQueue.pop())},flashPlayers:{},createFlash:function(b){this.flashPlayers[b.pluginId]=
...
function(a){mejs.YouTubeApi.handleStateChange(a,c,d)};c.addEventListener("onStateChange",b);setInterval(function(){mejs.YouTubeApi.createEvent(c,d,"timeupdate")},250)},handleStateChange:function(b,a,c){switch(b){case -1:c.paused=true;c.ended=true;mejs.YouTubeApi.createEvent(a,c,"loadedmetadata");break;case 0:c.paused=false;c.ended=true;mejs.YouTubeApi.createEvent(a,c,"ended");break;case 1:c.paused=false;c.ended=false;mejs.YouTubeApi.createEvent(a,c,"play");mejs.YouTubeApi.createEvent(a,c,"playing");
break;case 2:c.paused=true;c.ended=false;mejs.YouTubeApi.createEvent(a,c,"pause");break;case 3:mejs.YouTubeApi.createEvent(a,c,"progress")}}};function onYouTubePlayerAPIReady(){mejs.YouTubeApi.iFrameReady()}function onYouTubePlayerReady(b){mejs.YouTubeApi.flashReady(b)}window.mejs=mejs;window.MediaElement=mejs.MediaElement;if(typeof jQuery!="undefined")mejs.$=jQuery;else if(typeof ender!="undefined")mejs.$=ender;
...
isVideo:true,enableKeyboard:true,pauseOtherPlayers:true,keyActions:[{keys:[32,179],action:function(a,b){b.paused||b.ended?b.play():b.pause()}},{keys:[38],action:function(a,b){b.setVolume(Math.min(b.volume+0.1,1))}},{keys:[40],action:function(a,b){b.setVolume(Math.max(b.volume-0.1,0))}},{keys:[37,227],action:function(a,b){!isNaN(b.duration)&&b.duration>0&&(a.isVideo&&(a.showControls(),a.startControlsTimer()),b.setCurrentTime(Math.max(b.currentTime-b.duration*0.05,0)))}},{keys:[39,228],action:function(a,
b){!isNaN(b.duration)&&b.duration>0&&(a.isVideo&&(a.showControls(),a.startControlsTimer()),b.setCurrentTime(Math.min(b.currentTime+b.duration*0.05,b.duration)))}},{keys:[70],action:function(a){typeof a.enterFullScreen!="undefined"&&(a.isFullScreen?a.exitFullScreen():a.enterFullScreen())}}]};mejs.mepIndex=0;mejs.players=[];mejs.MediaElementPlayer=function(a,c){if(!(this instanceof mejs.MediaElementPlayer))return new mejs.MediaElementPlayer(a,c);this.$media=this.$node=b(a);this.node=this.media=this.$media[0];
if(typeof this.node.player!="undefined")return this.node.player;else this.node.player=this;typeof c=="undefined"&&(c=this.$node.data("mejsoptions"));this.options=b.extend({},mejs.MepDefaults,c);mejs.players.push(this);this.init();return this};mejs.MediaElementPlayer.prototype={hasFocus:false,controlsAreVisible:true,init:function(){var a=this,c=mejs.MediaFeatures,d=b.extend(true,{},a.options,{success:function(b,c){a.meReady(b,c)},error:function(b){a.handleError(b)}}),e=a.media.tagName.toLowerCase();
a.isDynamic=e!=="audio"&&e!=="video";a.isVideo=a.isDynamic?a.options.isVideo:e!=="audio"&&a.options.isVideo;if(c.isiPad&&a.options.iPadUseNativeControls||c.isiPhone&&a.options.iPhoneUseNativeControls)a.$media.attr("controls","controls"),c.isiPad&&a.media.getAttribute("autoplay")!==null&&(a.media.load(),a.media.play());else if(!c.isAndroid||!a.AndroidUseNativeControls)a.$media.removeAttr("controls"),a.id="mep_"+mejs.mepIndex++,a.container=b('<div id="'+a.id+'" class="mejs-container"><div class="mejs-inner"><div class="mejs-mediaelement"></div><div class="mejs-layers"></div><div class="mejs-controls"></div><div class="mejs-clear"></div></div></div>').addClass(a.$media[0].className).insertBefore(a.$media),
a.container.addClass((c.isAndroid?"mejs-android ":"")+(c.isiOS?"mejs-ios ":"")+(c.isiPad?"mejs-ipad ":"")+(c.isiPhone?"mejs-iphone ":"")+(a.isVideo?"mejs-video ":"mejs-audio ")),c.isiOS?(c=a.$media.clone(),a.container.find(".mejs-mediaelement").append(c),a.$media.remove(),a.$node=a.$media=c,a.node=a.media=c[0]):a.container.find(".mejs-mediaelement").append(a.$media),a.controls=a.container.find(".mejs-controls"),a.layers=a.container.find(".mejs-layers"),c=e.substring(0,1).toUpperCase()+e.substring(1),
a.width=a.options[e+"Width"]>0||a.options[e+"Width"].toString().indexOf("%")>-1?a.options[e+"Width"]:a.media.style.width!==""&&a.media.style.width!==null?a.media.style.width:a.media.getAttribute("width")!==null?a.$media.attr("width"):a.options["default"+c+"Width"],a.height=a.options[e+"Height"]>0||a.options[e+"Height"].toString().indexOf("%")>-1?a.options[e+"Height"]:a.media.style.height!==""&&a.media.style.height!==null?a.media.style.height:a.$media[0].getAttribute("height")!==null?a.$media.attr("height"):
a.options["default"+c+"Height"],a.setPlayerSize(a.width,a.height),d.pluginWidth=a.height,d.pluginHeight=a.width;mejs.MediaElement(a.$media[0],d)},showControls:function(a){var b=this;if(!b.controlsAreVisible)typeof a=="undefined"||a?(b.controls.css("visibility","visible").stop(true,true).fadeIn(200,function(){b.controlsAreVisible=true}),b.container.find(".mejs-control").css("visibility","visible").stop(true,true).fadeIn(200,function(){b.controlsAreVisible=true})):(b.controls.css("visibility","visible").css("display",
"block"),b.container.find(".mejs-control").css("visibility","visible").css("display","block"),b.controlsAreVisible=true),b.setControlsSize()},hideControls:function(a){var c=this;if(c.controlsAreVisible)typeof a=="undefined"||a?(c.controls.stop(true,true).fadeOut(200,function(){b(this).css("visibility","hidden").css("display","block");c.controlsAreVisible=false}),c.container.find(".mejs-control").stop(true,true).fadeOut(200,function(){b(this).css("visibility","hidden").css("display","block")})):(c.controls.css("visibility",
...
d.controls,d.layers,d.media);d.buildkeyboard(d,d.controls,d.layers,d.media);d.buildoverlays(d,d.controls,d.layers,d.media);d.findTracks();for(g in d.options.features)if(e=d.options.features[g],d["build"+e])try{d["build"+e](d,d.controls,d.layers,d.media)}catch(j){}d.container.trigger("controlsready");d.setPlayerSize(d.width,d.height);d.setControlsSize();d.isVideo&&(mejs.MediaFeatures.hasTouch?d.$media.bind("touchstart",function(){d.controlsAreVisible?d.hideControls(false):d.controlsEnabled&&d.showControls(false)}):
((d.media.pluginType=="native"?d.$media:b(d.media.pluginElement)).click(function(){a.paused?a.play():a.pause()}),d.container.bind("mouseenter mouseover",function(){d.controlsEnabled&&!d.options.alwaysShowControls&&(d.killControlsTimer("enter"),d.showControls(),d.startControlsTimer(2500))}).bind("mousemove",function(){d.controlsEnabled&&(d.controlsAreVisible||d.showControls(),d.options.alwaysShowControls||d.startControlsTimer(2500))}).bind("mouseleave",function(){d.controlsEnabled&&!d.media.paused&&
!d.options.alwaysShowControls&&d.startControlsTimer(1E3)})),f&&!d.options.alwaysShowControls&&d.hideControls(),d.options.enableAutosize&&d.media.addEventListener("loadedmetadata",function(a){d.options.videoHeight<=0&&d.domNode.getAttribute("height")===null&&!isNaN(a.target.videoHeight)&&(d.setPlayerSize(a.target.videoWidth,a.target.videoHeight),d.setControlsSize(),d.media.setVideoSize(a.target.videoWidth,a.target.videoHeight))},false));a.addEventListener("play",function(){for(var a=0,b=mejs.players.length;a<
...
d.updateCurrent&&d.updateCurrent();d.isFullScreen||(d.setPlayerSize(d.width,d.height),d.setControlsSize())},false);setTimeout(function(){d.setPlayerSize(d.width,d.height);d.setControlsSize()},50);b(window).resize(function(){d.isFullScreen||mejs.MediaFeatures.hasTrueNativeFullScreen&&document.webkitIsFullScreen||d.setPlayerSize(d.width,d.height);d.setControlsSize()});d.media.pluginType=="youtube"&&d.container.find(".mejs-overlay-play").hide()}f&&a.pluginType=="native"&&(a.load(),a.play());d.options.success&&
(typeof d.options.success=="string"?window[d.options.success](d.media,d.domNode,d):d.options.success(d.media,d.domNode,d))}},handleError:function(a){this.controls.hide();this.options.error&&this.options.error(a)},setPlayerSize:function(a,c){if(typeof a!="undefined")this.width=a;if(typeof c!="undefined")this.height=c;if(this.height.toString().indexOf("%")>0){var d=this.media.videoWidth&&this.media.videoWidth>0?this.media.videoWidth:this.options.defaultVideoWidth,e=this.media.videoHeight&&this.media.videoHeight>
0?this.media.videoHeight:this.options.defaultVideoHeight,f=this.container.parent().width(),d=parseInt(f*e/d,10);this.container.parent()[0].tagName.toLowerCase()==="body"&&(f=b(window).width(),d=b(window).height());this.container.width(f).height(d);this.$media.width("100%").height("100%");this.container.find("object, embed, iframe").width("100%").height("100%");this.media.setVideoSize&&this.media.setVideoSize(f,d);this.layers.children(".mejs-layer").width("100%").height("100%")}else this.container.width(this.width).height(this.height),
...
(function(b){b.extend(mejs.MepDefaults,{stopText:"Stop"});b.extend(MediaElementPlayer.prototype,{buildstop:function(a,c,d,e){b('<div class="mejs-button mejs-stop-button mejs-stop"><button type="button" aria-controls="'+this.id+'" title="'+this.options.stopText+'"></button></div>').appendTo(c).click(function(){e.paused||e.pause();e.currentTime>0&&(e.setCurrentTime(0),c.find(".mejs-time-current").width("0px"),c.find(".mejs-time-handle").css("left","0px"),c.find(".mejs-time-float-current").html(mejs.Utility.secondsToTimeCode(0)),
...
c.find(".mejs-time-total"),d=c.find(".mejs-time-loaded"),g=c.find(".mejs-time-current"),j=c.find(".mejs-time-handle"),h=c.find(".mejs-time-float"),l=c.find(".mejs-time-float-current"),k=function(a){var a=a.pageX,b=f.offset(),c=f.outerWidth(),d=0,g=a-b.left;a>b.left&&a<=c+b.left&&e.duration&&(d=(a-b.left)/c,d=d<=0.02?0:d*e.duration,m&&e.setCurrentTime(d),mejs.MediaFeatures.hasTouch||(h.css("left",g),l.html(mejs.Utility.secondsToTimeCode(d)),h.show()))},m=false;f.bind("mousedown",function(a){if(a.which===
1)return m=true,k(a),b(document).bind("mousemove.dur",function(a){k(a)}).bind("mouseup.dur",function(){m=false;h.hide();b(document).unbind(".dur")}),false}).bind("mouseenter",function(){b(document).bind("mousemove.dur",function(a){k(a)});mejs.MediaFeatures.hasTouch||h.show()}).bind("mouseleave",function(){m||(b(document).unbind(".dur"),h.hide())});e.addEventListener("progress",function(b){a.setProgressRail(b);a.setCurrentRail(b)},false);e.addEventListener("timeupdate",function(b){a.setProgressRail(b);
a.setCurrentRail(b)},false);this.loaded=d;this.total=f;this.current=g;this.handle=j},setProgressRail:function(a){var b=a!=void 0?a.target:this.media,d=null;b&&b.buffered&&b.buffered.length>0&&b.buffered.end&&b.duration?d=b.buffered.end(0)/b.duration:b&&b.bytesTotal!=void 0&&b.bytesTotal>0&&b.bufferedBytes!=void 0?d=b.bufferedBytes/b.bytesTotal:a&&a.lengthComputable&&a.total!=0&&(d=a.loaded/a.total);d!==null&&(d=Math.min(1,Math.max(0,d)),this.loaded&&this.total&&this.loaded.width(this.total.width()*
...
f=="vertical"){var c=h.height(),d=h.position(),e=c-c*a;k.css("top",d.top+e-k.height()/2);l.height(c-e);l.css("top",d.top+e)}else c=h.width(),d=h.position(),c*=a,k.css("left",d.left+c-k.width()/2),l.width(c)},n=function(a){var b=null,c=h.offset();if(f=="vertical"){if(b=h.height(),parseInt(h.css("top").replace(/px/,""),10),b=(b-(a.pageY-c.top))/b,c.top==0||c.left==0)return}else b=h.width(),b=(a.pageX-c.left)/b;b=Math.max(0,b);b=Math.min(b,1);m(b);b==0?e.setMuted(true):e.setMuted(false);e.setVolume(b)},
o=false,p=false;g.hover(function(){j.show();p=true},function(){p=false;!o&&f=="vertical"&&j.hide()});j.bind("mouseover",function(){p=true}).bind("mousedown",function(a){n(a);b(document).bind("mousemove.vol",function(a){n(a)}).bind("mouseup.vol",function(){o=false;b(document).unbind(".vol");!p&&f=="vertical"&&j.hide()});o=true;return false});g.find("button").click(function(){e.setMuted(!e.muted)});e.addEventListener("volumechange",function(){o||(e.muted?(m(0),g.removeClass("mejs-mute").addClass("mejs-unmute")):
(m(e.volume),g.removeClass("mejs-unmute").addClass("mejs-mute")))},false);this.container.is(":visible")&&(m(a.options.startVolume),e.pluginType==="native"&&e.setVolume(a.options.startVolume))}}})})(mejs.$);
...
function(){mejs.MediaFeatures.isFullScreen()?(a.isNativeFullScreen=true,a.setControlsSize()):(a.isNativeFullScreen=false,a.exitFullScreen())}));var f=this,g=b('<div class="mejs-button mejs-fullscreen-button"><button type="button" aria-controls="'+f.id+'" title="'+f.options.fullscreenText+'"></button></div>').appendTo(c);if(f.media.pluginType==="native"||!f.options.usePluginFullScreen&&!mejs.MediaFeatures.isFirefox)g.click(function(){mejs.MediaFeatures.hasTrueNativeFullScreen&&mejs.MediaFeatures.isFullScreen()||
a.isFullScreen?a.exitFullScreen():a.enterFullScreen()});else{var j=null,c=function(){var a=document.createElement("x"),b=document.documentElement,c=window.getComputedStyle;if(!("pointerEvents"in a.style))return false;a.style.pointerEvents="auto";a.style.pointerEvents="x";b.appendChild(a);c=c&&c(a,"").pointerEvents==="auto";b.removeChild(a);return!!c}();console.log("supportsPointerEvents",c);if(c&&!mejs.MediaFeatures.isOpera){var h=false,l=function(){h&&(k.hide(),m.hide(),n.hide(),g.css("pointer-events",
""),f.controls.css("pointer-events",""),h=false)},k=b('<div class="mejs-fullscreen-hover" />').appendTo(f.container).mouseover(l),m=b('<div class="mejs-fullscreen-hover"  />').appendTo(f.container).mouseover(l),n=b('<div class="mejs-fullscreen-hover"  />').appendTo(f.container).mouseover(l),o=function(){var a={position:"absolute",top:0,left:0};k.css(a);m.css(a);n.css(a);k.width(f.container.width()).height(f.container.height()-f.controls.height());a=g.offset().left-f.container.offset().left;fullScreenBtnWidth=
g.outerWidth(true);m.width(a).height(f.controls.height()).css({top:f.container.height()-f.controls.height()});n.width(f.container.width()-a-fullScreenBtnWidth).height(f.controls.height()).css({top:f.container.height()-f.controls.height(),left:a+fullScreenBtnWidth})};b(document).resize(function(){o()});g.mouseover(function(){if(!f.isFullScreen){var b=g.offset(),c=a.container.offset();e.positionFullscreenButton(b.left-c.left,b.top-c.top,false);g.css("pointer-events","none");f.controls.css("pointer-events",
"none");k.show();n.show();m.show();o();h=true}});e.addEventListener("fullscreenchange",function(){l()})}else g.mouseover(function(){j!==null&&(clearTimeout(j),delete j);var b=g.offset(),c=a.container.offset();e.positionFullscreenButton(b.left-c.left,b.top-c.top,true)}).mouseout(function(){j!==null&&(clearTimeout(j),delete j);j=setTimeout(function(){e.hideFullscreenButton()},1500)})}a.fullscreenBtn=g;b(document).bind("keydown",function(b){(mejs.MediaFeatures.hasTrueNativeFullScreen&&mejs.MediaFeatures.isFullScreen()||
f.isFullScreen)&&b.keyCode==27&&a.exitFullScreen()})}},enterFullScreen:function(){var a=this;if(!(a.media.pluginType!=="native"&&(mejs.MediaFeatures.isFirefox||a.options.usePluginFullScreen))){docStyleOverflow=document.documentElement.style.overflow;document.documentElement.style.overflow="hidden";normalHeight=a.container.height();normalWidth=a.container.width();if(a.media.pluginType==="native")if(mejs.MediaFeatures.hasTrueNativeFullScreen)mejs.MediaFeatures.requestFullScreen(a.container[0]),a.isInIframe&&
setTimeout(function e(){a.isNativeFullScreen&&(b(window).width()!==screen.width?a.exitFullScreen():setTimeout(e,500))},500);else if(mejs.MediaFeatures.hasSemiNativeFullScreen){a.media.webkitEnterFullscreen();return}if(a.isInIframe){var c=a.options.newWindowCallback(this);if(c!=="")if(mejs.MediaFeatures.hasTrueNativeFullScreen)setTimeout(function(){a.isNativeFullScreen||(a.pause(),window.open(c,a.id,"top=0,left=0,width="+screen.availWidth+",height="+screen.availHeight+",resizable=yes,scrollbars=no,status=no,toolbar=no"))},
...
pattern_timecode:/^([0-9]{2}:[0-9]{2}:[0-9]{2}([,.][0-9]{1,3})?) --\> ([0-9]{2}:[0-9]{2}:[0-9]{2}([,.][0-9]{3})?)(.*)$/,split2:function(a,b){return a.split(b)},parse:function(a){for(var b=0,a=this.split2(a,/\r?\n/),d={text:[],times:[]},e,f;b<a.length;b++)if(this.pattern_identifier.exec(a[b])&&(b++,(e=this.pattern_timecode.exec(a[b]))&&b<a.length)){b++;f=a[b];for(b++;a[b]!==""&&b<a.length;)f=f+"\n"+a[b],b++;d.text.push(f);d.times.push({start:mejs.Utility.timeCodeToSeconds(e[1]),stop:mejs.Utility.timeCodeToSeconds(e[3]),
settings:e[5]})}return d}};if("x\n\ny".split(/\n/gi).length!=3)mejs.TrackFormatParser.split2=function(a,b){var d=[],e="",f;for(f=0;f<a.length;f++)e+=a.substring(f,f+1),b.test(e)&&(d.push(e.replace(b,"")),e="");d.push(e);return d}})(mejs.$);
