...
<div class="sermon">
    ...
    <?php if ($this->checkPosition('vimeo_embed')) { ?>
        <?php $videoid = str_replace(' ', '-', trim($this->renderPosition('vimeo_name'))); ?>
        <a class="video-pop" href="#<?php echo $videoid; ?>">
            <h4 class="blue nomar"><img style="height:12px;" src="/images/camera-icon.png"/><?php echo $this->renderPosition('vimeo_name'); ?></h4>
        </a>
        <div style="display:none;">
            <div id="<?php echo $videoid; ?>">
                <?php echo $this->renderPosition('vimeo_embed'); ?>
            </div>
        </div>
    <?php } ?>
    ...
    <?php if ($this->checkPosition('video_name')) { ?>
        <div class="sermon_player">
            ...
            <div class="sermon_video"><a href=""><img src="/images/sermon_video.png"></img></a></div>
