        ...
        <h4>
            ...
            foreach ($tweets as $tweetData) {
                if ($i != 0) {
                    ...
                    <?php echo $tweet; ?>
                    <?php /* Commented out the time of tweet
                     * <br /><span class="tweet_time"><?php echo $pub; ?> - <a href="<?php echo $link; ?>"<?php echo ($params->get('linktype') == 'blank') ? ' target="_blank"' : ''; ?>><?php echo JText::_('view'); ?> &raquo;</a>
                     */
                    ?>
