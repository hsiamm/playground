<?php
/**
 * NoNumber! Elements Helper File: Assignments: Resources
 *
...
*/
class NoNumberElementsAssignmentsResources
{
	var $_version = '2.9.1';
	...
	function passCategories_MR( &$main, &$params, $selection = array(), $assignment = 'all', $article = 0 )
	{
		...
		if ( $pass && $params->inc_children == 2 ) {
			...
			foreach ( $cats as $cat ) {
				$cats = array_merge( $cats, NoNumberElementsAssignmentsResources::getCatParentIds( $main, $cat ) );
			}
		}
