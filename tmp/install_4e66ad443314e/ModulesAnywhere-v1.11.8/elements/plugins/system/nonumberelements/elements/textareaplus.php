...
class nnElementTextAreaPlus
{
	...
	function getInput( $name, $id, $value, $params, $children, $j15 = 0 )
	{
		...
		if( $resize ) {
			...
			$document->addScript( JURI::root(true).'/plugins/system/nonumberelements/elements/textareaplus/textareaplus.js?v='.$this->_version );
			$document->addStyleSheet( JURI::root(true).'/plugins/system/nonumberelements/elements/textareaplus/textareaplus.css?v='.$this->_version );
...
if ( version_compare( JVERSION, '1.6.0', 'l' ) ) {
	...
	// For Joomla 1.6
	class JFormFieldTextAreaPlus extends JFormField
	{
		/**
		 * The form field type
		 *
