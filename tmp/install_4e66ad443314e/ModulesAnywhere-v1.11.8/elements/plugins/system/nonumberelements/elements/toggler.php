 ...
 * value			a comma separated list of value on which to show the elements
 */
class nnElementToggler
{
	var $_version = '2.9.1';
	...
	function getInput( $name, $id, $value, $params, $children, $j15 = 0 )
	{
		...
		$document->addScript( JURI::root(true).'/plugins/system/nonumberelements/elements/toggler.js?v='.$this->_version );
		$document->addStyleSheet( JURI::root(true).'/plugins/system/nonumberelements/elements/style.css?v='.$this->_version );
