...
if ( typeof( nn_toggler_version ) == 'undefined' || nnVersionIsNewer( nn_toggler_version, '2.8.4' ) ) {
	// version number of the script
	// to prevent this from overwriting newer versions if other extensions include the script too
	var nn_toggler_version = '2.8.4';
	...
	var nnToggler = new Class({
		...
		initTogglers: function()
		{
			...
			this.div_elements = document.getElements( 'div.col div, div.fltrt div' );
