...
class nnElementColorPicker
{
	...
	function getInput( $name, $id, $value, $params, $children, $j15 = 0 )
	{
		...
		$document->addStyleSheet( JURI::root(true).'/plugins/system/nonumberelements/fields/colorpicker/js_color_picker_v2.css?v='.$this->_version );
		$document->addScript( JURI::root(true).'/plugins/system/nonumberelements/fields/colorpicker/color_functions.js?v='.$this->_version );
		$document->addScript( JURI::root(true).'/plugins/system/nonumberelements/fields/colorpicker/js_color_picker_v2.js?v='.$this->_version );
