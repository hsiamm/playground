...
class CountryHelper extends AppHelper {
	...
	/**
	* Convert iso code (2 digits) to country name
	*
	* @param $iso_code
	*/
	...
	/**
	* Convert iso code (3 digits) to country name
	*
	* @param $iso_code
	*/
	...
	/**
	* Convert iso code (2 digits) to iso code (3 digits)
	*
	* @param $iso_code
	*/
	...
	/**
	* Convert iso code (3 digits) to iso code (2 digits)
	*
	* @param $iso_code
	*/
	...
	/**
	* Check if is european union country
	*
	* @param $iso_code
	*/
	...
	/**
	* Get Iso to name country mapping
	*/
